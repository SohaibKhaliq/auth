...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($num == 0) {
        ...
        $update_query = "UPDATE users SET reset_token='$reset_token', reset_token_expiry='$reset_token_expiry' WHERE email='$email'";
        ...
        <div class="user_options-container">
            <div class="user_options-text">
                <div class="user_options-unregistered">
                    ...
                    <button class="user_unregistered-signup" onclick="window.location.href='index.php'">Back to Login</button>
                </div>
                ...
                <div class="user_options-registered">
                    ...
                    <button class="user_registered-login" onclick="window.location.href='index.php'">Sign Up</button>
                </div>
            </div>
